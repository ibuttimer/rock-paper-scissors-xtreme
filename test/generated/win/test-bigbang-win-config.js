/**
    Configuration override to generate big bang game variant win view
    @author Ian Buttimer
*/
...
*/
localStorage.setItem('MODE', 'managed');

/* Player and robot input, a comma-separated list of game key characters */
localStorage.setItem('INPUT', 'p,r,r,r,r,r,r,r,r,r,r,r');
